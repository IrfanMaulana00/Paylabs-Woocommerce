	...
	<div id="content" role="main">
		<div class="row">
			<div class="large-12 colums"  style="border: double; border-color:#71235a; padding-left:20px; padding-right:20px; padding-top:15px; margin-bottom:20px">
                ...
                <h1 class="va-number"> Nomor Virtual Account : <b><?= $va ?></b> </h1>

                <?php if($result['status']==self::STATUS_PENDING): ?>

                    <div class="guide">
                        Silahkan melakukan transfer ke nomor virtual account yang tertera di atas untuk menyelesaikan transaksi.
                    </div>
